  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application, your one-stop solution for seamless human resources management, ensuring efficient workflow and maximized productivity."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application, your one-stop solution for seamless human resources management, ensuring efficient workflow and maximized productivity.`}
            </Text>
            <Box
