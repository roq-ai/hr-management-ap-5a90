...
import { useRoqPlatformUserProfiles, useApplicationCount, useEmployeeCount, useJobPostingCount } from 'lib/roq';

import { JobPostingListPage as ShowCaseList } from 'pages/job-postings';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`job-postings`} passHref legacyBehavior>
                  <Button
